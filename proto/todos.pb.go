...
func (x *SomeMessage) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *SomeMessage) GetDescription() string {
	if x != nil {
...
func (x *SomeMessage) GetAssignee() string {
	if x != nil {
		return x.Assignee
	}
	return ""
...
func (x *SomeMessage) GetAssignedBy() string {
	if x != nil {
		return x.AssignedBy
	}
	return ""
...
var file_todos_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x6f, 0x73, 0x22, 0x91, 0x01, 0x0a, 0x0b, 0x53, 0x6f, 0x6d, 0x65, 0x4d, 0x65, 0x73,
	...
	0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x61, 0x73, 0x73, 0x69,
	0x67, 0x6e, 0x65, 0x64, 0x42, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x73,
	0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x42, 0x79, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x3b, 0x74, 0x6f,
...
var file_todos_proto_goTypes = []interface{}{
	(*SomeMessage)(nil), // 0: todos.SomeMessage
}
